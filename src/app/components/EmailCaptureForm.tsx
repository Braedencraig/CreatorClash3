...
export const EmailCaptureForm = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center justify-center p-6 mb-8 text-white rounded-lg shadow-lg max-w-md mx-auto space-y-4 mt-16 md:mt-24 border border-white"
    >
      {success ? (
